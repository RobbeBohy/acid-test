...
# Validation of STACIE 1.0.0 with the ACID test set
...
This directory tests the STACIE 1.0.0 with the `ExpPolyModel([0, 2])` and `LorentzModel()`,
...
1. Run the preceding workflow as explained in
   [`../../1_dataset/README.md`](../../1_dataset/README.md).
